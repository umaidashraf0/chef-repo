...
CHEF_SERVER_NAME="chef-server1" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="chef-server1-7vyova5pddfnbdj1.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server

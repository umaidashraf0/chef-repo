<powershell>
 ...
 $env:CHEF_SERVER_NAME = "chef-server1" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "chef-server1-7vyova5pddfnbdj1.us-east-1.opsworks-cm.io" # FQDN of your Chef Server

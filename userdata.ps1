<powershell>
 ...
 $env:CHEF_SERVER_NAME = "HU-chef-server" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "hu-chef-server-ydqnhvgnriq7etfs.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
